...
struct AllocationResult {
  ...
  std::unordered_map<const ir::CallInst*, std::vector<PhysReg>> caller_to_save;
  ...
  // offset_t spill_reg_offset() const { return 0; } // Always 0.
  ...
  offset_t func_args_offset() const { return return_addr_offset() + 8; }
  offset_t local_var_offset() const { return func_args_offset() + spill_args_num * 8; }
};
