...
class Parser {
  ...
  std::unique_ptr<FieldExpression> parseFieldExpression(std::unique_ptr<Expression> &&lft);
  std::unique_ptr<ContinueExpression> parseContinueExpression();
  std::unique_ptr<BreakExpression> parseBreakExpression();
  std::unique_ptr<RangeExpression> parseRangeExpression(std::unique_ptr<Expression> &&expr, Operator oper);
  std::unique_ptr<RangeExpr> parseRangeExpr();
  std::unique_ptr<RangeFromExpr> parseRangeFromExpr();
  std::unique_ptr<RangeToExpr> parseRangeToExpr();
  std::unique_ptr<RangeFullExpr> parseRangeFullExpr();
  std::unique_ptr<RangeInclusiveExpr> parseRangeInclusiveExpr();
  std::unique_ptr<RangeToInclusiveExpr> parseRangeToInclusiveExpr();
