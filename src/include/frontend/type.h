...
public:
  FunctionType(
    StringT ident,
    TypePtr impl_type_opt,
    TypePtr self_type_opt,
    std::vector<TypePtr> &&params,
    TypePtr ret_type
  ): ExprType(TypeKind::kFunction), _ident(std::move(ident)), _impl_type_opt(std::move(impl_type_opt)),
  ...
  TypePtr impl_type_opt() const { return _impl_type_opt; }
